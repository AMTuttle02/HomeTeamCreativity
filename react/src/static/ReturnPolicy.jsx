...
function ReturnPolicy() {
  ...
  return (
    <div className="ReturnPolicy">
      <br />
      <h1 className="center"> Return Policy </h1>
      <br />
      <div className="container">
        <p>
          ...
          the product will look like either by ordering custom and receiving
          ...
          addressed before an order is placed. If you are not happy with your
